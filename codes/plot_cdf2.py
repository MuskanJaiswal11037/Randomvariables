...
randvar = np.loadtxt('codes/vdis.dat',dtype='double')
...
plt.savefig('/home/muskan/Documents/Probability/figs/vdis_cdf.pdf')
plt.savefig('/home/muskan/Documents/Probability/figs/vdis_cdf.eps')
